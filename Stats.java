//----------------------------------
//Programmer:	Candido Renteria
//Course: 		COSC 1336 Section 006
//Semester:		Summer 3023
//Assignment:	9
...
public class Stats {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				"Thnk you for your number. Your range " +
		...
		for (i = 0; i < numbers.length; i++)
		{
			...
			else	// odd number element, display
			{		// on same line but then advance
					// to new line at end
		...
		JOptionPane.showMessageDialog(null, 
				output, 
				"Your array with then generated numbers",
				JOptionPane.INFORMATION_MESSAGE);
		...
		JOptionPane.showMessageDialog(null,
				"This program was written by Candido Renteria." +
				"\nEnd of program.",
				"Good bye!",
				JOptionPane.INFORMATION_MESSAGE);
